                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: AppTextStyles.titleSmall(context)
                            ...
                            .withColor(isSelected ? Colors.white : colorScheme.onSurface),
                      ),
                    ],
                  ),
                ),
    ...
    showModalBottomSheet(
      ...
      builder: (context) => Container(
        constraints: BoxConstraints(
          maxHeight: ResponsiveUtils.heightPercent(context, 0.6),
        ),
        decoration: BoxDecoration(
          color: colorScheme.surface,
                  ...
                  return Padding(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Text(location, style: AppTextStyles.labelLarge(context).copyWith(color: accentColor)),
                          const SizedBox(width: AppSizes.gapXS),
                          GestureDetector(
