...
Future<void> showMingrrOptionsSheet({
  ...
  return showMingrrBottomSheet(
    ...
    padding: EdgeInsets.only(bottom: ResponsiveUtils.bottomSafeArea(context)),
...
class MingrrBottomButtonBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: Theme.of(context).colorScheme.surface,
        boxShadow: showShadow ? AppShadows.shadowL(Theme.of(context).brightness == Brightness.dark) : null,
      ),
      child: child,
    );
  }
