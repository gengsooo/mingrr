        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: AppTextStyles.bodyLarge(context).withColor(colorScheme.onSurfaceVariant),
              ...
              prefixIcon: Padding(
                ...
                child: Text(
                  '#',
                  style: AppTextStyles.titleMedium(context).withColor(widget.accentColor),
                ),
              ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text(
            '#$tag',
            style: AppTextStyles.bodyMedium(context).withWeight(FontWeight.w500).withColor(accentColor),
          ),
          GestureDetector(
            onTap: onRemove,
